...
```{r}
batch_size = 1024
history <- model %>% fit(x_train, y_train, batch_size = batch_size, epochs = 4, validation_split =0.2)
plot(history)
```
...
#batch_size = 1024
batch_sizes = c(128,256,512,1024)
vec_epochs = c(3,5,8,12,15)
for (epochs in vec_epochs){
